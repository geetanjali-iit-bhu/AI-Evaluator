...
def retrieve_for_evaluation(vector_store, question):
    return retrieve_chunks(vector_store, question, k=5)
...
def safe_llm_json(prompt: str):
    """
    Forces LLM → extracts valid JSON safely
    """
    from rag_pipeline import _call_llm
